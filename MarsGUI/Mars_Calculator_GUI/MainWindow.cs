...
public partial class MainWindow : Gtk.Window
{
	...
	protected void OnButton1Clicked(object sender, EventArgs e)                 //class created when the calculate button is pressed, all math happens inside here
    {
       ...
       {
	       entry2.Text = ("You should put in a positive integer");             //alternative so that if the user puts in anything other than a positive integer, the second text box will tell them to do so.
       }
    }
}
